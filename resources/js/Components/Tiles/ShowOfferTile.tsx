...
const ShowOfferTile = (props: ShowOfferTileProps) => {
    ...
    return (
        <div
            {...props}
            className={`w-full px-2 py-4 flex flex-col space-y-4 bg-slate-300 hover:bg-slate-200 dark:bg-slate-700 dark:hover:bg-slate-800 border border-slate-400 rounded drop-shadow-xl ${className}`}
        >
