...
const Contacts = () => {
    return (
        <div className="w-full flex flex-col space-y-8 sm:space-y-12 md:flex-row md:justify-between md:max-w-2xl md:space-y-0 lg:max-w-3xl">
            <div className="w-1/3 min-w-max flex items-center space-x-2 lg:space-x-4">
                <MdOutlineAlternateEmail className="w-6 h-6" />
                <p>bedrich.stojdl@email.cz</p>
            </div>
            <div className="w-1/3 min-w-max flex items-center md:justify-center space-x-2 lg:space-x-4">
            ...
            <div className="w-1/3 min-w-max flex items-center md:justify-end space-x-2 lg:space-x-4">
