<?php
    return [
        "overview" => [
            "heading" => "Projekty, na kterých jsem se podílel",
        ...
        "paradigma" => [
            "paragraph" => "Interní sekce firmy, u které jsem dříve pracoval. Spočívala
        ...
        "lms" => [
            "subtitle" => "Testy",
            "paragraph" => "Velice komplexní webová aplikace pro výcvik pilotů, na které
                            pracovali moji dřívější super kolegové. Mně přiřadili testování
                            tohoto projektu, takže jsem se učil studováním jejich kódů a následně
                            jsem na jejich kódy tvořil testy.",
            "paragraph2" => "Ve skutečnosti to byl můj poslední projekt, který se mě týkal v minulé
                             firmě, protože jsem musel přestat pracovat ze zdravotních důvodů.",
